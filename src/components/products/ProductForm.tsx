  ...
  useEffect(() => {
    const loadSubcategories = async () => {
      try {
        ...
        const categoryId = categories.find(cat => cat === selectedCategory)?.id;
        if (categoryId) {
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <div className="flex flex-col space-y-3">
                ...
                <FormDescription>
                  Upload a main image for this product (optional).
                </FormDescription>
                <FormMessage />
              </div>
            </FormItem>
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <div className="flex flex-col space-y-3">
                ...
                <FormDescription>
                  Upload additional images to show more product views (optional).
                </FormDescription>
                <FormMessage />
              </div>
            </FormItem>
